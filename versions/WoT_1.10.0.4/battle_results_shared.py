...
VEH_CELL_RESULTS_EXTS = {'extPublic': {'recoveryMechanic': _buildMapsForExt((
                                    'numRecovered', int, 0, None, 'sum')), 
                 'sector': _buildMapsForExt((
                          'numCaptured', int, 0, None, 'sum')), 
                 'destructibleEntity': _buildMapsForExt((
                                      'numDestroyed', int, 0, None, 'sum'), (
                                      'damageDealt', int, 0, None, 'sum'), (
                                      'hits', int, 0, None, 'sum')), 
                 'defenderBonus': _buildMapsForExt((
                                 'numDefended', int, 0, None, 'sum'))}, 
   'extPrivate': {}, 'extServer': {'achievementsData': _buildMapsForExt((
                                    'ironShieldDamage', int, 0, None, 'sum'), (
                                    'occupyingForceDestruction', bool, False, None, 'max'), (
                                    'occupyingForceBasePoints', int, 0, None, 'sum'))}}
_VEH_CELL_RESULTS_PUBLIC = Meta((
 'health', int, 0, None, 'skip'), (
 'maxHealth', int, 0, None, 'skip'), (
 'credits', int, 0, None, 'sum'), (
 'xp', int, 0, None, 'sum'), (
 'xp/attack', int, 0, None, 'sum'), (
 'xp/assist', int, 0, None, 'sum'), (
 'xp/other', int, 0, None, 'sum'), (
 'xpPenalty', int, 0, None, 'skip'), (
 ...
 'equipmentDamageDealt', int, 0, None, 'sum'), (
 'damageAssistedRadio', int, 0, None, 'sum'), (
 'damageAssistedTrack', int, 0, None, 'sum'), (
 'damageAssistedStun', int, 0, None, 'sum'), (
 'damageAssistedSmoke', int, 0, None, 'sum'), (
 'damageAssistedInspire', int, 0, None, 'sum'), (
...
_VEH_CELL_RESULTS_PRIVATE = Meta((
 ...
 'extPrivate', dict, {}, BunchProxyPacker(VEH_CELL_RESULTS_EXTS['extPrivate']), 'joinExts'))
_VEH_CELL_RESULTS_SERVER = Meta((
 ...
 'assistEventList', dict, {}, None, 'joinTargetEventLists'), (
 'damageFromEnemiesEventList', dict, {}, None, 'joinTargetEventLists'), (
 ...
 'extServer', dict, {}, BunchProxyPacker(VEH_CELL_RESULTS_EXTS['extServer']), 'joinExts'), (
...
_VEH_BASE_RESULTS_PRIVATE = Meta((
 ...
 'eventCoin', int, 0, None, 'sum'), (
 'piggyBank', int, 0, None, 'sum'))
...
_AVATAR_CELL_RESULTS_SERVER = Meta((
 'avatarAmmoEquipped', set, set(), None, 'skip'))
...
_AVATAR_BASE_PRIVATE_RESULTS = Meta((
 ...
 'prevMaxRank', tuple, (0, 0), None, 'skip'), (
...
_AVATAR_BASE_PUBLIC_RESULTS_EXTS = {
   ...
   'epicMetaGame': _buildMapsForExt((
                  ...
                  'prevMetaLevel', tuple, (0, 1, 0), None, 'skip'), (
                  'metaLevel', tuple, (0, 1, 0), None, 'skip'), (
                  'flXP', int, 0, None, 'skip'), (
                  'originalFlXP', int, 0, None, 'skip'), (
                  'subtotalFlXP', int, 0, None, 'skip'), (
                  'boosterFlXP', int, 0, None, 'skip'), (
                  'boosterFlXPFactor100', int, 0, None, 'any'), (
                  'flXPReplay', str, '', ValueReplayPacker(), 'skip')), 
   'battlePass': _buildMapsForExt((
                'basePointsDiff', int, 0, None, 'skip'), (
                'sumPoints', int, 0, None, 'skip'), (
                'hasBattlePass', bool, False, None, 'skip'))}
_AVATAR_BASE_PUBLIC_RESULTS = Meta((
 ...
 'prevAccRank', tuple, (0, 0), None, 'skip'), (
 'badges', tuple, BadgesCommon.selectedBadgesEmpty(), None, 'skip'), (
 'ext', dict, {}, BunchProxyPacker(_AVATAR_BASE_PUBLIC_RESULTS_EXTS), 'joinExts'))
...
VEH_FULL_RESULTS_UPDATE = Meta((
 ...
 'originalEventCoin', int, 0, None, 'sum'), (
 'eventCoinReplay', str, '', ValueReplayPacker(), 'skip'), (
 ...
 'subtotalEventCoin', int, 0, None, 'sum'), (
 ...
 'eventEventCoinList', list, [], None, 'skip'), (
 ...
 'referral20XP', int, 0, None, 'sum'), (
 'referral20XPFactor100', int, 0, None, 'skip'), (
 'referral20Credits', int, 0, None, 'sum'), (
 'referral20CreditsFactor100', int, 0, None, 'skip'), (
 'premiumXPFactor100', int, 0, None, 'any'), (
 'premiumPlusXPFactor100', int, 0, None, 'any'), (
 'appliedPremiumXPFactor100', int, 0, None, 'any'), (
 'premiumTmenXPFactor100', int, 0, None, 'any'), (
 'premiumPlusTmenXPFactor100', int, 0, None, 'any'), (
 'appliedPremiumTmenXPFactor100', int, 0, None, 'any'), (
 'premiumCreditsFactor100', int, 0, None, 'any'), (
 'premiumPlusCreditsFactor100', int, 0, None, 'any'), (
 'appliedPremiumCreditsFactor100', int, 0, None, 'any'), (
 'premSquadCreditsFactor100', int, 0, None, 'any'), (
 'originalPremSquadCredits', int, 0, None, 'any'), (
 'premSquadCredits', int, 0, None, 'any'), (
 'dailyXPFactor10', int, 0, None, 'max'), (
 'additionalXPFactor10', int, 0, None, 'skip'), (
 ...
 'playerRankXP', int, 0, None, 'sum'), (
 'playerRankXPFactor100', int, 0, None, 'any'), (
 'isPremium', bool, False, None, 'any'), (
 'premMask', int, 0, None, 'any'), (
...
_VEH_FULL_RESULTS_PRIVATE = Meta((
 ...
 'originalCreditsContributionOutSquad', int, 0, None, 'sum'))
