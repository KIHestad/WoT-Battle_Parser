...
class ARENA_GUI_TYPE:
    ...
    RANGE = (
     ...
     EPIC_RANDOM, EPIC_RANDOM_TRAINING, EPIC_BATTLE, EPIC_TRAINING, BATTLE_ROYALE)
    RANDOM_RANGE = (
     RANDOM, EPIC_RANDOM)
    SANDBOX_RANGE = (
...
class PREBATTLE_TYPE:
    ...
    RANGE = (
     ...
     EPIC, EPIC_TRAINING, BATTLE_ROYALE)
    LEGACY_PREBATTLES = (
     TRAINING, TOURNAMENT, CLAN, EPIC_TRAINING)
    SQUAD_PREBATTLES = (
     SQUAD, FALLOUT, EVENT, EPIC, BATTLE_ROYALE)
    UNIT_MGR_PREBATTLES = (
     UNIT, SQUAD, CLAN, FALLOUT, EVENT, STRONGHOLD,
     E_SPORT_COMMON, EPIC, BATTLE_ROYALE)
    CREATE_FROM_CLIENT = (
     UNIT, SQUAD, EPIC, FALLOUT, EVENT, BATTLE_ROYALE)
    CREATE_FROM_WEB = (
    ...
    CREATE_EX_FROM_SERVER = (
     SQUAD, CLAN, EPIC, BATTLE_ROYALE, EVENT)
    CREATE_EX_FROM_WEB = (
     SQUAD, CLAN)
    JOIN_EX = (
     SQUAD, EPIC, EVENT)
...
class UNIT_ASSEMBLER_FLAG:
    ...
    ALL = (
     IGNORE_RATING, ONLY_NEW_TEAM, KICK_AFTER_BATTLE, ASSEMBLE_NEW_UNITS)
...
class INVITATION_TYPE:
    ...
    RANGE = (
     SQUAD, EVENT, EPIC, BATTLE_ROYALE)
