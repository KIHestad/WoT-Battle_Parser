...
class ARENA_GUI_TYPE:
    ...
    RANGE = (
     ...
     EPIC_RANDOM, EPIC_RANDOM_TRAINING, EPIC_BATTLE, EPIC_TRAINING, BATTLE_ROYALE, BOB)
    RANDOM_RANGE = (
     RANDOM, EPIC_RANDOM)
    SANDBOX_RANGE = (
...
class ARENA_BONUS_TYPE:
    ...
    RANGE = (
     ...
     BATTLE_ROYALE_SOLO, BATTLE_ROYALE_SQUAD, BOB)
    RANDOM_RANGE = (
     REGULAR, EPIC_RANDOM)
...
class PREBATTLE_TYPE:
    ...
    RANGE = (
     ...
     EPIC, EPIC_TRAINING, BATTLE_ROYALE, BOB)
    LEGACY_PREBATTLES = (
     TRAINING, TOURNAMENT, CLAN, EPIC_TRAINING)
    SQUAD_PREBATTLES = (
     SQUAD, FALLOUT, EVENT, EPIC, BATTLE_ROYALE, BOB)
    UNIT_MGR_PREBATTLES = (
     UNIT, SQUAD, CLAN, FALLOUT, EVENT, STRONGHOLD,
     E_SPORT_COMMON, EPIC, BATTLE_ROYALE, BOB)
    CREATE_FROM_CLIENT = (
     UNIT, SQUAD, EPIC, FALLOUT, EVENT, BATTLE_ROYALE, BOB)
    CREATE_FROM_WEB = (
    ...
    CREATE_EX_FROM_SERVER = (
     SQUAD, CLAN, EPIC, BATTLE_ROYALE, EVENT, BOB)
    CREATE_EX_FROM_WEB = (
     SQUAD, CLAN)
    JOIN_EX = (
     SQUAD, EPIC, EVENT, BOB)
    EPIC_PREBATTLES = (
     EPIC, EPIC_TRAINING)
    REMOVED = (
     COMPANY, CLUBS)
...
class QUEUE_TYPE:
    ...
    ALL = (
     ...
     SPEC_BATTLE, FALLOUT,
     FALLOUT_CLASSIC, FALLOUT_MULTITEAM, STRONGHOLD_UNITS, RANKED, BOOTCAMP, EPIC, TOURNAMENT_UNITS,
     BATTLE_ROYALE, BOB)
    REMOVED = (
     COMPANIES,)
...
class INVITATION_TYPE:
    ...
    RANGE = (
     SQUAD, EVENT, EPIC, BATTLE_ROYALE, BOB)
