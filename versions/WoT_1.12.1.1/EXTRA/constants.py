...
class ARENA_GUI_TYPE:
    ...
    RANGE = (
     ...
     EPIC_RANDOM, EPIC_RANDOM_TRAINING, EPIC_BATTLE, EPIC_TRAINING, BATTLE_ROYALE, WEEKEND_BRAWL)
    RANDOM_RANGE = (
     RANDOM, EPIC_RANDOM)
    SANDBOX_RANGE = (
...
class PREBATTLE_TYPE:
    ...
    RANGE = (
     ...
     EPIC, EPIC_TRAINING, BATTLE_ROYALE, BATTLE_ROYALE_TOURNAMENT, WEEKEND_BRAWL)
    LEGACY_PREBATTLES = (
     TRAINING, TOURNAMENT, CLAN, EPIC_TRAINING)
    SQUAD_PREBATTLES = (
     SQUAD, FALLOUT, EVENT, EPIC, BATTLE_ROYALE, WEEKEND_BRAWL)
    UNIT_MGR_PREBATTLES = (
     UNIT, SQUAD, CLAN, FALLOUT, EVENT, STRONGHOLD,
     E_SPORT_COMMON, EPIC, BATTLE_ROYALE, BATTLE_ROYALE_TOURNAMENT, WEEKEND_BRAWL)
    CREATE_FROM_CLIENT = (
     UNIT, SQUAD, EPIC, FALLOUT, EVENT, BATTLE_ROYALE, BATTLE_ROYALE_TOURNAMENT, WEEKEND_BRAWL)
    CREATE_FROM_WEB = (
     UNIT, SQUAD, STRONGHOLD)
    TRAININGS = (
     TRAINING, EPIC_TRAINING)
    EXTERNAL_PREBATTLES = (
     STRONGHOLD, TOURNAMENT)
    CREATE_EX_FROM_SERVER = (
     SQUAD, CLAN, EPIC, BATTLE_ROYALE, EVENT, BATTLE_ROYALE_TOURNAMENT, WEEKEND_BRAWL)
    CREATE_EX_FROM_WEB = (
     SQUAD, CLAN)
    JOIN_EX = (
     SQUAD, EPIC, EVENT, WEEKEND_BRAWL)
    EPIC_PREBATTLES = (
     EPIC, EPIC_TRAINING)
    REMOVED = (
     COMPANY, CLUBS)
...
DAMAGE_INFO_CODES = ('DEVICE_CRITICAL', 'DEVICE_DESTROYED', 'TANKMAN_HIT', 'FIRE',
                     'DEVICE_CRITICAL_AT_SHOT', 'DEVICE_DESTROYED_AT_SHOT', 'DEVICE_CRITICAL_AT_RAMMING',
                     ...
                     'DEATH_FROM_ARTILLERY_SECTOR', 'DEATH_FROM_BOMBER', 'FIRE_STOPPED',
                     'DEATH_FROM_RECOVERY', 'DEATH_FROM_KAMIKAZE')
...
class QUEUE_TYPE:
    ...
    ALL = (
     ...
     BATTLE_ROYALE_TOURNAMENT, WEEKEND_BRAWL)
    REMOVED = (
     COMPANIES,)
...
class INVITATION_TYPE:
    ...
    RANGE = (
     SQUAD, EVENT, EPIC, BATTLE_ROYALE, WEEKEND_BRAWL)
...
def getTimeOnArenaOf(arenaUniqueID, eventTime):
    if eventTime == UNKNOWN_TIME_ON_ARENA:
        return UNKNOWN_TIME_ON_ARENA
    return int(eventTime - getArenaStartTime(arenaUniqueID))
...
class LocalizableBotName(object):
    CONFIGS = {BotNamingType.CREW_MEMBER: BotNamingConfig('BotCrew_', (int, int, int), '_'), 
       ...
       BotNamingType.CUSTOM: BotNamingConfig('BotLoc_', (str,), '')}
...
class ROLE_TYPE:
    ...
    TANK_ONE = 1
    TANK_TWO = 2
    FIRST_LINE_SUPPORT_ONE = 3
    FIRST_LINE_SUPPORT_TWO = 4
    FIRST_LINE_SUPPORT_THREE = 5
    FIRST_LINE_SUPPORT_FOUR = 6
    FIRST_LINE_SUPPORT_FIVE = 7
    FIRE_SUPPORT_ONE = 8
    FIRE_SUPPORT_TWO = 9
    SNIPER = 10
    SCOUT_ONE = 11
