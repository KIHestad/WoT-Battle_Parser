...
def main(): 
    ...
    try: 
        ...
        legacyBattleResultVersion, brAllDataRaw = pickle.load(cachefile)
...
class Unpickler(object): 
    ...
    def loads(cls, pickle_string):
        try:
            unpickler = pickle.Unpickler(StringIO.StringIO(pickle_string))
            return unpickler.load()
        except Exception as e:
            cachefile.close()
            raise pickle.UnpicklingError('Unpickler Error: ' + e.message)
    ...
    def load(cls, pickle_file):
        try:
            ...
            cachefile.close()
            raise pickle.UnpicklingError('Unpickler EOF Error: ' + er.message)
